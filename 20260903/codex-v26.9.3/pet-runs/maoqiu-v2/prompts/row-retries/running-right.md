...
Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: photorealistic gray British Shorthair cat, round broad face, dense plush gray coat, amber-yellow eyes, small blank metal name tag hanging on a collar; tsundere but reliable coding companion; whole-body silhouette readable at small sprite sizes. Preserve silhouette, face, palette, material, proportions, markings, and props.
